...
const fieldSchema = JSON.parse(fs.readFileSync('./schemas/field.json'));
const presetSchema = JSON.parse(fs.readFileSync('./schemas/preset.json'));
const categorySchema = JSON.parse(fs.readFileSync('./schemas/preset_category.json'));
const defaultsSchema = JSON.parse(fs.readFileSync('./schemas/preset_defaults.json'));
const deprecatedSchema = JSON.parse(fs.readFileSync('./schemas/deprecated.json'));
const discardedSchema = JSON.parse(fs.readFileSync('./schemas/discarded.json'));
...
function generatePresets(dataDir, tstrings, searchableFieldIDs, listReusedIcons) {
  ...
  glob.sync(dataDir + '/presets/**/*.json').forEach(file => {
    ...
    let names = new Set([preset.name.toLowerCase()]);
...
function generateTaginfo(presets, fields, deprecated, tstrings, projectInfo) {
  ...
  const packageInfo = JSON.parse(fs.readFileSync(process.cwd() + '/package.json'));
